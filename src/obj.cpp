...
int convert_object(const char* in_fn, const char* in_dir, const char* out_fn) 
{
    ...
    for (size_t m = 0; m < materials.size(); m++) 
    {
        ...
        std::strcat(model.m_matpool[m].diffuse_fn, "/");
    ...
    fs.write((const char*)(model.m_matpool), sizeof(game::Material) * 64);
    fs.write((const char*)(model.m_meshes), sizeof(game::Mesh) * 64);
